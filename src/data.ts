...
export const GALLERY_ITEMS: GalleryItem[] = [
  {
    id: 'g1',
    name: 'White Embroidered Agbada',
    category: 'agbada',
    description: 'White and cream Agbada with gold-toned embroidery design. A classic, regal look for weddings and big occasions.',
    image: 'https://i.postimg.cc/9QkzKCRD/download-(1).jpg',
    priceTag: 'Royal Selection',
  },
  {
    id: 'g2',
    name: 'Pinstripe Senator Wear',
    category: 'senator-wears',
    description: 'Black pinstripe senator wear with a contrast pocket and leaf-style embroidery. Sharp and corporate, good for the office.',
    image: 'https://i.postimg.cc/dVfDpwkw/download-(4).jpg',
    priceTag: 'Bestseller',
  },
  {
    id: 'g3',
    name: 'Classic Olive Kaftan',
    category: 'kaftans',
    description: 'Simple olive green kaftan with small diamond stitch detail on the chest. Easy, everyday native wear.',
    image: 'https://i.postimg.cc/cLz620gn/Kaftan.jpg',
    priceTag: 'Presidential',
  },
  {
    id: 'g4',
    name: 'Yoruba Caps (Fila)',
    category: 'wedding',
    description: 'Purple and grey striped Yoruba caps, neatly folded. Adds the finishing touch to any native outfit.',
    image: 'https://i.postimg.cc/SR4nddX2/yORUBA_CAPS.jpg',
    priceTag: 'Exclusive Wedding',
  },
  {
    id: 'g5',
    name: 'Brown Senator Wear',
    category: 'corporate',
    description: 'Rich brown senator wear with short sleeves, finished with gold beaded embroidery down the chest, shoulder, sleeve, and pocket. Simple, classy, and perfect for any occasion.',
    image: 'https://i.postimg.cc/dVfDpwk0/Men-Fashion-Senators-Umber.jpg',
    priceTag: 'Executive',
  },
  {
    id: 'g6',
    name: 'Brown Embroidered Agbada',
    category: 'agbada',
    description: 'Deep brown flowing Agbada with detailed cream-and-bronze geometric stitch design on the chest. Wide sleeves and rich pattern give it a bold, royal look for big occasions.',
    image: 'https://i.postimg.cc/52rjTbYf/AGBADA.jpg',
    priceTag: 'Heirloom',
  },
  {
    id: 'g7',
    name: 'Cream Senator Wear',
    category: 'senator-wears',
    description: 'Cream senator wear with neat brown star-pattern embroidery down the chest and on the pocket. Simple cross-stitch design that gives it a clean, traditional touch',
    image: 'https://i.postimg.cc/PrR23v4p/download-(5).jpg',
    priceTag: 'Modernist',
  },
  {
    id: 'g8',
    name: 'Charcoal Patterned Kaftan',
    category: 'wedding',
    description: 'Grey kaftan with a bold black-and-grey geometric pattern on the collar and chest. Great for events and ceremonies.',
